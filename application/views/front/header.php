         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             <div class="cartmini__top-wrapper">
                 ...
                 <div class="cartmini__widget">
                     ...
                     <div class="cartmini__widget-item" data-prod_id="<?= $cart->pro_id ?>">
                         ...
                         <div class="cartmini__content">
                           <h5 class="cartmini__title"><a href="product/<?= $cart->slug ?>"><?= $cart->pro_name ?></a></h5>
                         ...
                         <a href="#"  data-anch_cart_item_id = "<?= $cart->pro_id; ?>" data-href="cart/delete_product/<?= $cart->pro_id; ?>"  class="cartmini__del tp-cart-action-btn"><i class="fa-regular fa-xmark"></i></a>
                     </div>
							<?php endforeach;   ?>
                 </div>
					  <?php   else: ?>
                  ...
                  <div class="row align-items-center">
                           ...
                           <form method="get" action="<?= base_url()?>products/search">
                              <div class="tp-header-search-wrapper d-flex align-items-center">
                                 <div class="tp-header-search-box">
                                    <input type="text" name='search_item' value="<?= $this->input->get('search_item')?>" id="tp-header-search" placeholder="Search for Products...">
                                 </div>
                                 <div class="tp-header-search-category">
                                    <select name="category" >
                                       <option value=''>Select Category</option>
													<?php if(isset($get_category_nav)&&!empty($get_category_nav)): foreach($get_category_nav as $val): ?>
                                       <option  value='<?= $val->cate_id?>' <?php if($this->input->get('category')==$val->cate_id){echo 'selected';} ?>><?= $val->cate_name?></option> 
                     ...
                     <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                           <div class="tp-header-login d-none d-lg-block mr-10">
                              <a href="order/order_track" class="d-flex align-items-center">
                                 ...
                                 <div class="tp-header-login-content d-none d-xl-block">
                                    ...
                                    <h5 class="tp-header-login-title">Track Order</h5>
                                 </div>
                              </a>
                           </div>  <div class="tp-header-login d-none d-lg-block">
                        ...
                        <div class="col-xl-3 col-lg-3">
                           <div class="tp-header-category tp-category-menu tp-header-category-toggle">
                              ...
                              <nav class="tp-category-menu-content">
                               <ul>
											<?php if(!empty($get_category_nav )): foreach($get_category_nav as $val): 
												$check_sub = $this->HomeModel->get_subcat_check($val->cate_id);
													if($check_sub){
												?>
												 <li class="has-dropdown">
                                      <a href="category/<?= $val->slug?>" class="has-mega-menu">
                                         <span>
                                               ...
                                               <ul>
                                                  <!-- <li>
                                                     <a href="shop.html"><img src="assets_front/img/header/menu/menu-1.jpg" alt=""></a>
																  ...
																  <?php $sub_category= $this->HomeModel->get_category_nav($val->cate_id);
																 		if($sub_category):
																			foreach($sub_category as $sub_val):
																  ?>
                                                  <li>
                                                     <a href="category/<?= $val->slug?>/<?= $sub_val->slug?>"><?= $sub_val->cate_name?></a>
                                                  </li> 
																  <?php 
																		endforeach;
																  		endif;
