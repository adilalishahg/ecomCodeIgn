                           ...
                           <tbody id='cart_table'>
                              ...
                              <tr  data-prod_id="<?= $c->pro_id ?>">
                                 ...
                                 <td class="tp-cart-action">
                                    <a class="tp-cart-action-btn"  data-anch_cart_item_id = "<?= $c->pro_id; ?>" data-href="cart/delete_product/<?= $c->pro_id; ?>">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-cart-checkout-wrapper">
                        ...
                        <div class="tp-cart-checkout-proceed">
                           <a href="<?php echo base_url();?>checkout" class="tp-cart-checkout-btn w-100">Proceed to Checkout</a>
                        </div>  
                     </div>
                  </div>
