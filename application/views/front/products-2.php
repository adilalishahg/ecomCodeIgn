...
<body>
					...
					<div class="tp-shop-widget-content">
						<div class="tp-shop-widget-categories">
							<ul>
								...
								<li><a href="#" class="filter_ajax" data-key="categories" data-id="<?= $cat->cate_id?>"><?= $cat->cate_name?> <span><?= $cat->id?></span></a></li>
							...
							<div class="tp-shop-items-wrapper tp-shop-item-primary">
								<div class="tab-content" id="productTabContent">
									<div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
										...
										<?php if($product):foreach($product as $prod):?>
											<div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
												<div class="tp-product-item-2 mb-40">
													<div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
														<a href="product/<?= $prod->slug?>">
															<img src="assets_front/images/products/<?= $prod->pro_main_image?>" alt="">
														</a>
														<!-- product action -->
														<div class="tp-product-action-2 tp-product-action-blackStyle">
															<div class="tp-product-action-item-2 d-flex flex-column">
																<button type="button" class="tp-product-action-btn-2 tp-product-add-cart-btn"  data-id='<?= $prod->prod_id ?>' data-route='<?= base_url() ?>cart/add_to_cart'>
																...
																<button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn"  data-view_id="<?= $prod->prod_id?>" data-slug="<?= $prod->slug?>"  data-view_url="product/<?= $prod->slug ?>">
													...
													<div class="tp-product-content-2 pt-15">
														<div class="tp-product-tag-2">
															<a href="product/<?= $prod->slug?>">Whitetails Store</a>
														</div>
														<h3 class="tp-product-title-2">
															<a href="product/<?= $prod->slug?>"><?= $prod->pro_name?></a>
														</h3>
														...
														<div class="tp-product-price-wrapper-2">
															<span class="tp-product-price-2 new-price"><?= $prod->mrp?></span>
															<span class="tp-product-price-2 old-price"><?= $prod->selling_price?></span>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="tab-pane fade" id="list-tab-pane" role="tabpanel" aria-labelledby="list-tab" tabindex="0">
										<div class="tp-shop-list-wrapper tp-shop-item-primary mb-70">
											...
											<?php if($product):foreach($product as $prod):?>
												<div class="col-xl-12">
												<div class="alert  alert-dismissible " role="alert" data-alert_id='<?= $prod->prod_id ?>'></div>
														...
														<div class="tp-product-list-content">
															<div class="tp-product-content-2 pt-15">
																...
																<div class="tp-product-list-add-to-cart">
																	<button class="tp-product-list-add-to-cart-btn  tp-product-add-cart-btn"   data-id='<?= $prod->prod_id ?>' data-route='<?= base_url() ?>cart/add_to_cart'>Add To Cart</button>
																</div>
															</div>
														</div>
													</div>
	...
	<script>
		...
		data_array = <?php print_r(json_encode($product));?>;
