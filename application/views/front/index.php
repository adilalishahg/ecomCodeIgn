                        ...
                        <div class="row align-items-center">
                           <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="tp-slider-content p-relative z-index-1">
                                 ...
                                 <div class="tp-slider-btn">
                                    <a href="<?=base_url()?>products/all" class="tp-btn tp-btn-2 tp-btn-white">Shop Now
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="assets_front/img/slider/<?php echo $bann->banner_image; ?>" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="category/<?= $cat->slug?>">
                              <img src="assets_front/images/category/<?= $cat->cat_image ?>" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                              <a href="category/<?= $cat->slug?>"><?= ucfirst($cat->cate_name); ?></a>
                           </h3>
                           <p>20 Product</p>
                        </div>
                     </div>
                           ...
                           <div class="tab-pane fade show active" id="new-tab-pane" role="tabpanel" aria-labelledby="new-tab" tabindex="0">
							...
							if (!empty($products)){
								foreach ($products as   $prod) {
									// print_r($bann);exit;
										$cat_name = $this->HomeModel->category_name($prod->category);
									?>
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product/<?= $prod->slug ?>">
                                             <img src="assets_front/images/products/<?= $prod->pro_main_image ?>" alt="product-electronic">
                                          </a>
                                          ...
                                          <div class="tp-product-action">
                                             <div class="tp-product-action-item d-flex flex-column">
															<input type='hidden' name='pro_id'  value="<?= $prod->prod_id;?>">
																
                                                <button type="button" class="tp-product-action-btn tp-product-add-cart-btn" data-id='<?= $prod->prod_id ?>' data-route='<?= base_url() ?>cart/add_to_cart'>
                                                ...
                                                <button type="button" class="tp-product-action-btn tp-product-quick-view-btn" data-view_id="<?= $prod->prod_id?>" data-slug="<?= $prod->slug?>"  data-view_url="product/<?= $prod->slug ?>">
																	<input type="hidden" class="view_id" data-view_id="<?= $prod->prod_id?>"  data-view_url="product/<?= $prod->slug ?>"/>
                                       ...
                                       <div class="tp-product-content">
                                          <div class="tp-product-category">
                                             <a href="<?=base_url()?>products/all"><?= $cat_name ?></a>
                                          </div>
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price"><?= number_format($prod->mrp,2) ?></span>
                                             <span class="tp-product-price new-price"><?= number_format($prod->selling_price,2) ?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                  ...
                  <div class="col-xl-8 col-md-7 col-sm-6">
                     <div class="tp-product-offer-more-wrapper d-flex justify-content-sm-end p-relative z-index-1">
                        <div class="tp-product-offer-more mb-40 text-sm-end grey-bg-2">
                           <a href="<?= base_url()?>products/all" class="tp-btn tp-btn-2 tp-btn-blue">View All Deals 
                              <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M16 6.99976L1 6.99976" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M9.9502 0.975414L16.0002 6.99941L9.9502 13.0244" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              </svg>
                        ...
                        <div class="tp-product-offer-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">HD Camera</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Electric</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Tablet Pro 8</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Headphone</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Pertronix</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Amazon</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                           ...
                           <div class="col-xl-4 col-sm-6">
                              <div class="tp-product-item p-relative transition-3 mb-25">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Medical</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                              ...
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-product-banner-content p-relative z-index-1">
                                    ...
                                    <div class="tp-product-banner-btn">
                                       <a href="<?=base_url()?>products/all" class="tp-btn tp-btn-2">Shop now</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-6 col-lg-6">
                        ...
                        <div class="tp-product-arrival-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-product-item transition-3 mb-25 swiper-slide">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Fast Charger</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Earbuds</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                              ...
                              <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                                 ...
                                 <div class="tp-product-content">
                                    <div class="tp-product-category">
                                       <a href="<?=base_url()?>products/all">Tablet</a>
                                    </div>
                                    <h3 class="tp-product-title">
                                       <a href="product-details.html">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">Iron Man</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">Speaker</a>
                                 </div>
                                 <h3 class="tp-product-title">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">Motherboard</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">Digital Camera</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">Smart Watches</a>
                                 </div>
                                 <h3 class="tp-product-title">
                     ...
                     <div class="tp-product-sm-list mb-50">
                        ...
                        <div class="tp-product-sm-wrapper mr-20">
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">Usb Flash Disk</a>
                                 </div>
                                 <h3 class="tp-product-title">
                           ...
                           <div class="tp-product-sm-item d-flex align-items-center">
                              ...
                              <div class="tp-product-sm-content">
                                 <div class="tp-product-category">
                                    <a href="<?=base_url()?>products/all">HawkEye</a>
                                 </div>
                                 <h3 class="tp-product-title">
